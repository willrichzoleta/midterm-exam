...
import rb from './IMG/rb5.jpg';
import gb from './IMG/gb1.jpg';
import mb from './IMG/mb2.jpg';
import bike from './IMG/bike.png';
import bike4 from './IMG/bike4.jpg';
import bike3 from './IMG/bike.jpg';
...
<>
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary navbar-custom">
          <div className="container-fluid">
            <a className="navbar-brand" href="indexc.php">THEO'S BIKE SHOP</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="indexc.php">HOME</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="customerschedule.php">PRODUCT</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="customerbookinghistory.php">ORDER</a>
                </li>
        ...
        <div className="container">
         ...
         <img src={bike4} className='img-fluid'></img>
         ...
         <div className="container" justify-content> 
          ...
          <div style={{backgroundColor: '#E3DAC9', padding: '20px;' }} />
              <div className="container" >
                  <div className="row">
                      <div className="col-md-6">
                          ...
                          <p>Follow Us: <a href="https://www.facebook.com/example">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="brown" className="bi bi-facebook" viewBox="0 0 16 16">
                                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                              </svg> </a>
                          <a href="https://twitter.com/example">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20"  fill="brown" className="bi bi-twitter-x" viewBox="0 0 16 16">
                                  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                              </svg></a>

                    <a href="https://www.instagram.com/example"><svg xmlns="http://www.w3.org/2000/svg" width="20"  fill="brown" className="bi bi-instagram" viewBox="0 0 16 16">
